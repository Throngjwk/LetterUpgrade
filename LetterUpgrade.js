...
var c1Exp, c2Exp, c3Exp, c4Exp, c5Exp, c6Exp;
...
var init = () => {
    ...
    // c4
    {
        ...
        c4 = theory.createUpgrade(3, currency, new ExponentialCost(4000, Math.log2(10)));
    ...
    // c5
    {
        ...
        c5 = theory.createUpgrade(4, currency, new ExponentialCost(30000, Math.log2(10)));
    ...
    // c6
    {
        ...
        c6 = theory.createUpgrade(5, currency, new ExponentialCost(30000, Math.log2(10)));
